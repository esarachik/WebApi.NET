...
/****** Object:  Database [Clients]    Script Date: 26/02/2019 00:21:40 ******/
CREATE DATABASE [Clients]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Clients', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\Clients.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Clients_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\Clients_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [Clients] SET COMPATIBILITY_LEVEL = 140
GO
...
ALTER DATABASE [Clients] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [Clients] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [Clients] SET QUERY_STORE = OFF
GO
